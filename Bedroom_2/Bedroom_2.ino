...
const int TacSwitch2 = D6;
const int TacSwitch3 = D7;
const int TacSwitch4 = D9;
...
void setup()
{
  ...
  wifi.autoConnect("Study Room"); //Create AP, if necessary
...
void ButtonCheck1() {
  // look for new button press
  boolean SwitchState1 = (digitalRead(TacSwitch2));
...
void ButtonCheck2() {
  // look for new button press
  boolean SwitchState2 = (digitalRead(TacSwitch3));
...
void ButtonCheck3() {
  // look for new button press
  boolean SwitchState3 = (digitalRead(TacSwitch4));
